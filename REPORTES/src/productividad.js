function crear_grafico5(canva, tipo, titulos, datos, label) {
 ...
 function llenar_grafico_productividad(fecha) {
   var fecha=$("#fecha_general").val();
    ...
    console.log(fecha);
    $.post("../controladores/controlador.php", { op: 'productividad_g', fecha_gra:fecha },
  ...
  function llenar_grafico_productividad_grupo(fecha) {
    var fecha=$("#fecha_general").val();
     ...
     console.log(fecha);
     $.post("../controladores/controlador.php", { op: 'productividad_grupo', fecha_gra:fecha },
     function (data, status) {
...
$(document).ready(function () {
    ...
    $("#contenedor_tabla_p").load('../tablas/tabla_p.php')
