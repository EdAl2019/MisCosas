...
{ // Clase para gestionar las consultas de las encuestas
    ...
    function listar_encuestadores()
    {
        ...
        global $instancia_conexion;
        $sql = "select p.nombres, p.apellidos,p.telefono,u.usuario, (select count(e.id_encuesta)from tbl_encuestas e where e.id_usuario=u.id_usuario) as cantidad_encuestas from tbl_usuarios u, tbl_personas p where u.id_persona=p.id_persona;";
        return $instancia_conexion->ejecutarConsulta($sql);
    }
